...
<?php foreach ($issue['sections'] as $section) { ?>
											<li class="<?php echo empty($section['parent']) ? 'top' : 'sub'; ?>">
												<a class="summary" href="<?php echo $_SERVER['REQUEST_URI']; ?>#<?php echo $section['name']; ?>"><?php echo $section['settings']['title']; ?></a>
											</li>
<?php } ?>
										</ul>
									</div>
